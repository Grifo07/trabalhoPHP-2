<?php /* Smarty version Smarty-3.1.15, created on 2017-01-26 01:02:44
...
"></input>
          ...
          <tr>
            <td width="25%" id="temcaixa">
              <?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['username'];?>
<input type="hidden" name="username" value="<?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['username'];?>
">
            </td>
            <td width="25%" id="temcaixa">
              <input type = "text" id="caixareg" name = "regtelemovel" value="<?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['regtelemovel'];?>
